...
class LightGCN_promax(BaseModel):
    ...
    def cal_loss(self, batch_data):
        ...
        user_ssl_loss = self.get_InfoNCE_loss(user_embeds[uni_ancs], user_embeds_2[uni_ancs], self.temperature)
        item_ssl_loss = self.get_InfoNCE_loss(item_embeds[uni_poss], item_embeds_2[uni_poss], self.temperature)

        inter_ssl_loss = self.get_InfoNCE_loss_cross(user_embeds[ancs], item_embeds[poss], user_embeds_2[ancs], item_embeds_2[poss], self.temperature)
